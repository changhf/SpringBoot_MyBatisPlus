...
public class SysFileController extends AbstractController {
    ...
    public Result upload(Integer uploadType, HttpServletRequest request) throws Exception {
        ...
        return Result.ok().put("filePath", fileContextPath);
    }
